      ...
      >
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            ...
            <div 
              className={`absolute right-0 mt-3 w-64 p-4 rounded-3xl bg-[#12031c]/95 border border-white/10 backdrop-blur-3xl shadow-2xl transition-all duration-500 origin-top-right flex flex-col ${
                isOpen 
